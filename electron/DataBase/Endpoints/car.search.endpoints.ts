import { handleIpcQuery } from "../../ipc";
...
// Devuelve el envelope como todos los demás. Antes tenía una forma propia
// —`{ status, cars, clients }`, con `status` pero sin `result`—, que es la
// tercera manera de contestar en un proyecto que ya tenía dos.
handleIpcQuery(
  "global:search",
  "No se pudo buscar",
